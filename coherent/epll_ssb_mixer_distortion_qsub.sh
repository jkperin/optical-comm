...
matlab -nodesktop -singleCompThread -r "epll_ssb_mixer_distortion_qsub $fiberLengthKm $ModBWGHz $CPRmethod $CPRNpol $linewidthKHz $Delayps $mixerVamp"