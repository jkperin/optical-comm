...
% \begin{table}[t]
%	\caption{Power consumption \cite{Pillai2014}}
...
%		\hline
%		DAC  & $E_{DAC} = 4F_Dn_dF_s/R_b$     \\
%		Photodiode & $E_{PD}=8RV_{bias}P_{rx}/R_b$ \\
%		TIA and ACG & $E_{TIA} = \frac{1.88}{R_b\log_2M}$ \\
%		ADC & $E_{ADC} = 4F_An_{adc}F_s/R_b$ \\
%		DSP:CD & $N_{CD} = 0.032R_sL_{km}D_{SMF}/1000$ \\
%		DSP:TR & 
%		\hline
%	\end{tabular}
%\end{table}
