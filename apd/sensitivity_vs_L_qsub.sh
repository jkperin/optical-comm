...
echo "sensitivity_vs_L_qsub $M $ka $level_spacing $BW0 $GainBW $modBW $lamb $Lkm"

matlab -nodesktop -singleCompThread -r "sensitivity_vs_L_qsub $M $ka $level_spacing $BW0 $GainBW $modBW $lamb $Lkm"
