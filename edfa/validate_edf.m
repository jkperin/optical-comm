...
Signal = Channels(linspace(1530, 1565, 88)*1e-9, 1e-4, 'forward');
...
[GaindB_approx, Psignal_out, Ppump_out] = E.gain_approx(Pump, Signal);
...
figure, plot(Signal.wavelength*1e9, GaindB, Signal.wavelength*1e9, GaindB_semi_analytical, '--',...
    Signal.wavelength*1e9, GaindB_approx, ':')
