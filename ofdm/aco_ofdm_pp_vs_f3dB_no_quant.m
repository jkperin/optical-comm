...
%         RCLIP = [4.2	4	3.7	3.7	3.7	3.7	3.7	3.7];       % optmized clipping ratio
%         RCLIP = [3.7000 3.7000 3.7000 3.7000 3.7000 3.7000 3.7000 3.7000];
        RCLIP = [3.9 4.0 3.8 3.8 3.7 3.7 3.7 3.7 3.7];
...
%         RCLIP = [4.5	4.5	4.5	4.5	4.3	4.2	4.2	4.2	4.2];       % optmized clipping ratio
%         RCLIP = [4.5000 4.5000 3.9000 3.9000 3.9000 4.2000 3.8000 3.8000 3.8000];
        RCLIP = [4.1 4.0 4.0 4.0 4.0 4.0 4.0 4.0 4.0];
...
%         RCLIP = [4.2	4	3.8	3.8	3.8	3.8	3.8	3.8	3.8];       % optmized clipping ratio
%          RCLIP = [4.2000 3.7000 3.7000 3.6000 3.5000 3.6000 3.5000 3.8000 3.5000];
        RCLIP = [3.9 3.9 3.8 3.8 3.8 3.8 3.8 3.8 3.8];
...
%         RCLIP = [4.2	4.2	4.2	4.2	4	3.9	3.9	3.9	3.9];       % optmized clipping ratio
%         RCLIP = [4.5000 4.2000 4.0000 3.9000 3.9000 3.9000 3.8000 4 3.7000];
        RCLIP = [4.5 4.3 4.3 4.3 4.3 4.2 4.2 4.2 4.2];
