...
%% cutoff frequency (f3dB) with quantization. The clipping ratio at the 
%% transmitter was optimize for each f3dB using the function aco_ofdm_ber_vs_clipping_ratio_tx.m
%% while the clipping ratio at the receiver was optimized for each f3dB using
%% the function aco_ofdm_ber_vs_clipping_ratio_rx.m
% clear, clc, close all
...
switch simulation_case
    case 1
        ...
        RCLIPTX = [3.8 3.8 3.7 3.7 3.7 3.7 3.7];       % optmized clipping ratio
        RCLIPRX = [4.5 4.0 3.5 3.4 3.3 3.3 3.2];       % optmized clipping ratio
    ...
    case 2
        ...
        RCLIPTX = [4.0 4.0 4.0 4.0 4.0 4.0 4.0];       % optmized clipping ratio
        RCLIPRX = [3.0 3.0 3.0 3.0 3.0 3.0 3.0];       % optmized clipping ratio
    ...
    case 3
        ...
        RCLIPTX = [4.0 3.8 3.8 3.7 3.7 3.7 3.7 3.7];       % optmized clipping ratio
        RCLIPRX = [7.2 5.8 4.5 4.0 3.7 3.4 3.4 3.4];       % optmized clipping ratio
    ...
    case 4
        ...
        RCLIPTX = [4.0 4.0 4.0 4.0 4.0 4.0 4.0 4.0];       % optmized clipping ratio
        RCLIPRX = [4.7 4.0 3.8 3.7 3.6 3.6 3.6 3.6];       % optmized clipping ratio
    ...
    case 5
        ...
        RCLIPTX = [3.9 3.9 3.8 3.8 3.8 3.8 3.8 3.8 3.8];       % optmized clipping ratio
        RCLIPRX = [4.0 3.6 3.6 3.0 3.0 3.0 3.0 3.0 3.0];       % optmized clipping ratio
    ...
    case 6
        ...
        RCLIPTX = [4.3 4.3 4.3 4.3 4.2 4.2 4.2 4.2];       % optmized clipping ratio
        RCLIPRX = [3.4 3.4 3.4 3.4 3.4 3.4 3.4 3.4];       % optmized clipping ratio
