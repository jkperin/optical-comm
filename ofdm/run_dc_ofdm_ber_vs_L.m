...
%% CS = 16
cases.ENOB = {5, 6, 5, 6,... % no shot no RIN
            5, 6, 5, 6,... % shot + RIN
            5, 6, 5, 6,... % only shot
            5, 6, 5, 6};   % only RIN

cases.type = {'preemphasis', 'preemphasis', 'palloc', 'palloc',...
              'preemphasis', 'preemphasis', 'palloc', 'palloc',...
              'preemphasis', 'preemphasis', 'palloc', 'palloc',...
              'preemphasis', 'preemphasis', 'palloc', 'palloc'};
          
cases.shot = {false, false, false, false,...
              true, true, true, true,...
              true, true, true, true,...
              false, false, false, false};

cases.RIN = {false, false, false, false,...
              true, true, true, true,...
              false, false, false, false,...
              true, true, true, true};
...
for ncase = 1:8
    ...
    results_CS_16QAM{ncase}.berc = bercount;
    results_CS_16QAM{ncase}.bere = berest;
    results_CS_16QAM{ncase}.power_pen_ook_m = power_pen_ook_m;
    results_CS_16QAM{ncase}.power_pen_ook_e = power_pen_ook_e;
end

save('results_CS_16QAM', 'results_CS_16QAM', 'cases')
