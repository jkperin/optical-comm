...
%% Pulse shape
pulse_shape.type = 'rrc'; % either 'rect', 'rrc', or 'rc'
...
switch lower(pulse_shape.type) 
    ...
    case 'rrc' % Root raised cosine pulse shape
        pulse_shape.rolloff = 0.2; % 
        pulse_shape.span = 4; % number of symbols over which pulse shape spans
...
Rx.ADC.fs = 2*Rx.ADC.ros*mpam.Rs*(mpam.pulse_shape.rolloff + 1)/2;
