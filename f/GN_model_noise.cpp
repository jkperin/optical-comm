...
void GN_model_noise(double * NL, double * P, double * Dn, double * D0, double * Dp, int N)
{   
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
    ...
    // GN_model_noise(double * NL, double * P, double * Dn, double * D0, double * Dp, int N)
    GN_model_noise(NL, P, Dn, D0, Dp, N);
